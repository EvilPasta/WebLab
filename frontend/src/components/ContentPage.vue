  ...
  <main class ="container" v-if = "product">
    ...
    <div class = "info">
      <div class="product-image">
        <img :src="require(`../assets/images/art/${product.id}.png`)"  class="book-img-cover" alt="">
      </div>

      <div class ="product-description">
        <div class="authors">Author: {{ product.author }}</div>
        <div class="type">Type: {{ product.type }}</div>

        <div class = "buying">
          <div class = "buying-price">
            <div class="buying-pricenew-text">Price: </div>
          ...
          <button  class="btn" @click = "addToCart(product)"><span class="text">Add <span>to cart</span></span></button>
      ...
      <div class = "product-about">
        <h4> {{product.author}}: "{{ product.title }}"</h4>
